...
;(function(window) {
	...
	Day.prototype._layout = function() {
		...
		*/
		...
		if(num==1)
		{
			var content="Your opinion lab";
		}
		if(num==2)
		{
			var content="Styleforms";
		}
		if(num==3)
		{
			var content="App development";
		}
		if(num==4)
		{
			var content="Survey programming";
		}
		if(num==5)
		{
			var content="Data analytics";
		}
		if(num==6)
		{
			var content="Staffing solutions";
		}
